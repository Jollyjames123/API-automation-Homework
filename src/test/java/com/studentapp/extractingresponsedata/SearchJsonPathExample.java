...
public class SearchJsonPathExample {
    ...
    @Test
    public void test002() {
        List<Integer> idList = response.extract().path("data.id"); // to get all the ids
        //response.extract().path("data[1].id"); // to get single id
    ...
    public void test004() {
        ...
        System.out.println("------------------StartingTest---------------------------");
       // System.out.println("The Categories list are : " +categoryList );
    ...
    public void test005() {
        ...
        List<HashMap<String, Object>> totalData = response.extract().path("data");

        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The size of the data is : "+totalData.size());
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    public void test006() {
        ...
        List<String> productsNames = response.extract().path("data.name");

        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The names of the products are : "+productsNames);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    // 10) Get the manufacturer of products whose name Starts with Ene
    @Test
    public void test010() {
    ...
    // 11) Get the price of products whose name have middle name = Vehicles
    @Test
    public void test011() {
        List<String> prices = response.extract().path("data.findAll{it.name==~/.*Vehicles.*/}.price");
    ...
    // Get the price of products whose name end with = Black
    @Test
    public void test011a() {
        List<String> prices = response.extract().path("data.findAll{it.name==~/.*Black/}.price");
